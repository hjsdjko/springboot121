...
public class FangwuxinxiController {
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<FangwuxinxiEntity> list = new ArrayList<FangwuxinxiEntity>();
        for(Long id : ids) {
            FangwuxinxiEntity fangwuxinxi = fangwuxinxiService.selectById(id);
            fangwuxinxi.setSfsh(sfsh);
            fangwuxinxi.setShhf(shhf);
            list.add(fangwuxinxi);
        }
        fangwuxinxiService.updateBatchById(list);
        return R.ok();
    }
